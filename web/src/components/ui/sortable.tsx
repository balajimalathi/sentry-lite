...
function SortableContent(props: SortableContentProps) {
  ...
  const ContentPrimitive = asChild || render ? Slot : "div";
...
function SortableItem(props: SortableItemProps) {
  ...
  const ItemPrimitive = asChild || render ? Slot : "div";
  const itemChildren = render
    ? React.cloneElement(render, undefined, children)
    : children;
...
function SortableItemHandle(props: SortableItemHandleProps) {
  const { asChild, disabled, className, ref, render, children, ...itemHandleProps } =
    props;
  ...
  const HandlePrimitive = asChild || render ? Slot : "button";
  const handleChildren = render
    ? React.cloneElement(render, undefined, children)
    : children;
